<?php get_header(); 
// ----- BANNER SECTI0N ------------------------------ //
if (get_theme_mod('homepage_banner') == true && get_theme_mod('is_parallax') == false) {
      get_template_part('inc/components/banner', 'simple');
} 
else if (get_theme_mod('homepage_banner') == true && get_theme_mod('is_parallax') == true) {
      get_template_part('inc/components/banner', 'parallax');
}
else if (get_theme_mod('homepage_slider') == true) {
    get_template_part('inc/components/banner', 'slider');
} 
// ----- BANNER SECTI0N END ------------------------------ //
global $wpdb;
