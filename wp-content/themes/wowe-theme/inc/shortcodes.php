...
$sc_name = $wpdb->get_results('SELECT `name` FROM ' . $wpdb->prefix . 'client_data');
$sc_email = $wpdb->get_results('SELECT `email` FROM ' . $wpdb->prefix . 'client_data');
$sc_phone = $wpdb->get_results('SELECT `phone` FROM ' . $wpdb->prefix . 'client_data');
$sc_businessname = $wpdb->get_results('SELECT `businessname` FROM ' . $wpdb->prefix . 'client_data');
$sc_street = $wpdb->get_results('SELECT `street` FROM ' . $wpdb->prefix . 'client_data');
$sc_city = $wpdb->get_results('SELECT `city` FROM ' . $wpdb->prefix . 'client_data');
$sc_state = $wpdb->get_results('SELECT `state` FROM ' . $wpdb->prefix . 'client_data');
$sc_zip = $wpdb->get_results('SELECT `zip` FROM ' . $wpdb->prefix . 'client_data');
$sc_job = $wpdb->get_results('SELECT `job` FROM ' . $wpdb->prefix . 'client_data');
*/
